...
<!-- <div  id="customer-spa" class="site"> -->
	...
	<header id="header-mfw-001" class="site-header">
		...
		<nav class="navbar navbar-expand-xl fixed-top">
			<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="logo img-fluid" src="/wp-content/uploads/2018/03/logo-round-75x75.png"></a>
