<template>
  ...
  <main class="contact-pg  wow bounceInUp">

    <h5>
      Contact Us
    </h5>
    <!-- <div v-html="contactPg.content.rendered"></div> -->
    <form>
...
export default {
  ...
  mounted: function() {
    ...
    // jQuery.get( '/wp-json/wp/v2/' + 'pages/248'  ).always((response) => {
    //   app.contactPg = response;

    //   return app.contactPg;
