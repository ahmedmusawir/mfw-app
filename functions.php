...
function moose_framework_2_scripts() {
   ...
   wp_deregister_script( 'jquery' );	
	...
	wp_enqueue_script( 'moose-framework-2-vue-js', 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.16/vue.min.js', array(), '20151215', true );
	wp_enqueue_script( 'moose-framework-2-jquery-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js', array(), '20151215', true );
	wp_enqueue_script( 'moose-framework-2-customer-spa-js', get_template_directory_uri() .  '/wp-spa/dist/build.js', array(), '20151215', true );
